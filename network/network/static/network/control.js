...
function build_post(post) {
    ...
    if (document.getElementById('following')) {
        ...
        like_icon.addEventListener('click', () => force_login(post));
    }
    ...
    likes_text.innerHTML = ": number of likes";
...
function edit_post(post) {
    ...
    save_button.innerHTML = "Commit Edits";
    ...
    content_editable.className = "for-control col-8";
    ...
    cancel_button.innerHTML = "Leave as is";
